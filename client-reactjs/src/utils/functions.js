...
// compose any numbers of functions is kind of using f andThen g ==== compose(f, g)
export const composes = (...fns) => (x) => fns.reduceRight((y, f) => f(y), x);
 ...
 */
export function objectEquals(obj, obj2) {
